...
namespace UniversityOfLiberia.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(UniversityOfLiberiaContext context)
        {
            _context = context;
        }
        ...
        {
            // Update the Include method to use the correct navigation property
            var universityOfLiberiaContext = _context.Courses.Include(c => c.Department);
            return View(await universityOfLiberiaContext.ToListAsync());
        }

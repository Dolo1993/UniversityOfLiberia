...
namespace UniversityOfLiberia.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public StudentsController(UniversityOfLiberiaContext context)
        {
            _context = context;
        }
    ...
    int? pageNumber)
        {
            ...
            {
                students = students.Where(s => s.StudentLastName.Contains(searchString)
                                       || s.StudentFirstMidName.Contains(searchString));
            }
            switch (sortOrder)
            {
                case "name_desc":
        ...
        public async Task<IActionResult> EditPost(int? id)
        {
            ...
            if (await TryUpdateModelAsync<Student>(
                studentToUpdate,
                "",
                s => s.StudentFirstMidName, s => s.StudentLastName, s => s.EnrollmentDate))
            {
                try
                {
                    await _context.SaveChangesAsync();
